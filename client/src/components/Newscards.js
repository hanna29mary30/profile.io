    ...
    return (
      <div className="container-fluid mt-6">
        <div className="row">
          ...
          <div className=" col-lg-3  " style={{ marginLeft: '125px', marginTop: '75px' }}>
          ...
          <div className="col-lg-3" style={{ marginLeft: '60px', marginTop: '75px' }}>
            ...
            <div className="alert alert-dark" role="alert">
              ...
              <p className="mb-0">
                <strong>Try saying:</strong><br />
                <i>Recent headlines in Science</i>
              </p>
            </div>
          </div>
          <div className="col-lg-3  justify-content-end" style={{ marginLeft: '50px', marginTop: '75px' }}>
            <div className="alert alert-dark" role="alert">
    ...
    <div className="container mt-8">
      <div className="row justify-content-center">
        {articles.map((article, i) => (
          <div key={article.id} className="col-sm-6 col-md-4 col-lg-3 mb-3">
